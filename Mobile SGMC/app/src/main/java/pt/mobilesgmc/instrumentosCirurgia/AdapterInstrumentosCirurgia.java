package pt.mobilesgmc.instrumentosCirurgia;
...
import pt.mobilesgmc.AparelhosActivity;
import pt.mobilesgmc.InstrumentalActivity;
 ...
 **/
public class AdapterInstrumentosCirurgia extends ArrayAdapter<ProdutosCirurgia> {
    ...
    public AdapterInstrumentosCirurgia(Context context, ArrayList<ProdutosCirurgia> itemsArrayList) {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                InstrumentalActivity.atualizaProdutos();
                            }
                        });
