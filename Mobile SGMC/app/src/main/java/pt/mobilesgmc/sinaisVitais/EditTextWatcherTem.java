 ...
 */
public class EditTextWatcherTem implements TextWatcher{


        private SinaisVitais sinaisVitais;

        public EditTextWatcherTem(SinaisVitais data) {
        ...
        public void afterTextChanged(Editable s) {
            ...
            try{
                ...
                sinaisVitais.setTemp(Double.parseDouble(s.toString()));
            }
            catch (Exception e){
                sinaisVitais.setTemp(0.0);
