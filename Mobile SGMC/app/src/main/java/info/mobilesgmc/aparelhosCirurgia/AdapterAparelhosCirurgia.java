package info.mobilesgmc.aparelhosCirurgia;
...
import info.mobilesgmc.AparelhosActivity;
 ...
 **/
public class AdapterAparelhosCirurgia extends ArrayAdapter<ProdutosCirurgia> {
    ...
    public AdapterAparelhosCirurgia(Context context, ArrayList<ProdutosCirurgia> itemsArrayList) {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                AparelhosActivity.atualizaProdutos();
                            }
                        });
