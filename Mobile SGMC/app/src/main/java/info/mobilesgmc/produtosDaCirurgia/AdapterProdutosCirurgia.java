package info.mobilesgmc.produtosDaCirurgia;
...
import info.mobilesgmc.ListaProdutosActivity;
 ...
 **/
public class AdapterProdutosCirurgia extends ArrayAdapter<ProdutosCirurgia> {
    ...
    public AdapterProdutosCirurgia(Context context, ArrayList<ProdutosCirurgia> itemsArrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        checkBox_preparado.setChecked(itemsArrayList.get(position).getPreparado());


        checkBox_preparado.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                itemsArrayList.get(position).setPreparado(checkBox_preparado.isChecked());
            }
        });
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        alert.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                ListaProdutosActivity.atualizaProdutos();
                            }
                        });
