...
public class Notifications {
	...
	public Notifications(Context contexto,String texto)
	{
		NotificationCompat.Builder mBuilder =
		        new NotificationCompat.Builder(contexto)
		        .setSmallIcon(R.drawable.ic_launcher)
		        .setContentTitle("SGMC Mobile")
		        .setContentText(texto);
		// Creates an explicit intent for an Activity in your app
		Intent resultIntent = new Intent(contexto, EquipaCirurgica.class);
		...
		stackBuilder.addParentStack(EquipaCirurgica.class);
